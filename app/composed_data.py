    ...
    *,
    ...
    for index, record in enumerate(selected_pairs, start=1):
        ...
        review_metadata = {
            ...
            "split_tier": str(record.get("split_tier", "")).strip(),
            "benchmark_eligible": bool(record.get("benchmark_eligible")),
            "training_eligible": bool(record.get("training_eligible")),
            "diagnostic_reason": record.get("diagnostic_reason", []),
            "b_subtype": str(record.get("b_subtype", "")).strip(),
            "edit_text": str(record.get("edit_text", "")).strip(),
            "difference": record.get("difference", {}),
            "reference_video": reference_video_raw,
            "target_video": target_video_raw,
            ...
            "audio_verdict": {
                ...
                "audio_delta_strength": record.get("audio_delta_strength", quality.get("audio_delta_strength")),
                "asr_degeneracy_risk": record.get("asr_degeneracy_risk", quality.get("asr_degeneracy_risk")),
                "audio_only_solvability": record.get("audio_only_solvability", quality.get("audio_only_solvability")),
                "full_av_required": record.get("full_av_required", quality.get("full_av_required")),
            },
