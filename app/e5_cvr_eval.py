                ...
                json.dumps(
                    {
                        ...
                        "target_encoding_audio_mode": video_audio_mode,
                        "query_encoding_audio_mode": video_audio_mode,
...
def _comparison_markdown(comparison: dict[str, Any]) -> str:
    lines = [
        ...
        f"- target_encoding_audio_mode: `{comparison.get('target_encoding_audio_mode', comparison['video_audio_mode'])}`",
        f"- query_encoding_audio_mode: `{comparison.get('query_encoding_audio_mode', comparison['video_audio_mode'])}`",
