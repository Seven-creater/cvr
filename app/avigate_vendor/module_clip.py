...
class ASTModel(nn.Module):
    ...
    """
    def __init__(self, label_dim=1, fstride=10, tstride=10, input_fdim=128, input_tdim=1024, imagenet_pretrain=True, audioset_pretrain=True, model_size='base384', verbose=False):
...
#             print('ImageNet pretraining: {:s}, AudioSet pretraining: {:s}'.format(str(imagenet_pretrain),str(audioset_pretrain)))
        ...
        if audioset_pretrain == False:
            ...
            audio_pretrained_path = '/data02/pretrained_model/cvr_learn/cvr_model/03_audio_vlm2vec_backbone/ast/audioset_10_10_0.4593.pth'
...
class CLIP(nn.Module):
    ...
    def get_config(pretrained_clip_name="ViT-B/32"):
        model_path = "/data02/pretrained_model/cvr_learn/cvr_model/01_lightweight_task_specific/clip/ViT-B-32.pt"
        if pretrained_clip_name in _MODELS and pretrained_clip_name in _PT_NAME:
            model_path = os.path.join("/data02/pretrained_model/cvr_learn/cvr_model/01_lightweight_task_specific/clip", _PT_NAME[pretrained_clip_name])
