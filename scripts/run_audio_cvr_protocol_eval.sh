...
Usage:
  bash scripts/run_audio_cvr_protocol_eval.sh \
    ...
    [--run-label LABEL] [--gallery-size 1000] [--seed 13] \
...
embeddings, runs eval with top-k diagnostics, and writes summary tables.
EOF
}
...
OUTPUT_DIR=""
ADAPTER_DIR=""
RUN_LABEL="Audio-CVR Protocol Eval"
GALLERY_SIZE=1000
SEED=13
MAX_TRAIN_RECORDS=0
MAX_EVAL_RECORDS=0
